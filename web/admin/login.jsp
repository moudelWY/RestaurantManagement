...
<script type="text/javascript" src="admin/resources/scripts/pintuer.js"></script>
<title></title>
...
<div class="container">
    <div class="line bouncein">
        <div class="xs6 xm4 xs3-move xm4-move">
            ...
            <form action="${pageContext.request.contextPath }/admin/AdminController?action=login" method="post">
            <div class="panel loginbox">
                <div class="text-center margin-big padding-big-top"><h1>阿婆私房菜系统登录</h1> <div style="color: red">${err}</div></div>
