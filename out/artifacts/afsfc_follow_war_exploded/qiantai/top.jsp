					...
					<div class="pdv_border"
						...
						<div style="padding: 0px">
							<div id="topmenu">
								...
								<a href="<%=request.getContextPath()%>/qiantai/login.jsp" target="_self">会员登录</a>|
								<a href="<%=request.getContextPath()%>/qiantai/reg.jsp" target="_self">会员注册</a>|
								<a href="<%=request.getContextPath()%>/users/UserController?action=loginOut">注销退出</a>|
							...
							<div id="menu">
								...
								<div id="mainmenu">
									<ul>
										...
										<li><a href="<%=request.getContextPath()%>/qiantai/shoppingcar.jsp" target="_self">我的餐车</a></li>
